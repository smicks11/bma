...
class AdminCompleteProfile extends StatefulWidget {
  const AdminCompleteProfile({ Key key }) : super(key: key);

  @override
  _AdminCompleteProfileState createState() => _AdminCompleteProfileState();
}
            ...
            children: [
              ...
              PrimaryButton(
                ...
                press: isEnabled == true
                    ? () async {
                        print(UserPreferences.getAdminCredentialUid());
                        setState(() {
                          loading = true;
                        });
                        await Future.delayed(Duration(seconds: 2), () {
                          _addToDb.completeAdminProfileToDB(
                            name: fullName,
                            email: email,
                            context: context,
